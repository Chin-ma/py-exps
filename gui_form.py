...
c1 = Checkbutton(base,text="English", variable = vars1).place(x=230,y=330)
  
#the new variable 'vars1' is created to store Integer Value, which by default is 0.  
vars2=IntVar()  
#Using the Checkbutton widget to create a button and using place() method to set its position.  
c2 = Checkbutton(base, text="German ", variable=vars2).place(x=300, y=330)
...
Button(base, text='Submit', command = ask_confirmation, width=20, bg="black",fg='white').place(x=180,y=380)
